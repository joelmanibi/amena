...
const siteCopy = {
  fr: {
    ...
    home: {
      ...
      teamSection: {
        eyebrow: 'Equipe',
        title: 'Les femmes et les hommes qui portent l’exigence AMENA CONSULTING',
        description: 'Une équipe engagée au service de la finance, du conseil et de l’exécution opérationnelle, présentée dans un format vivant et éditorial.',
        spotlightLabel: 'Membre en lumière',
    ...
    about: {
      ...
      teamSection: {
        ...
        title: 'Des profils complementaires pour accompagner vos priorites strategiques',
        description: 'Découvrez les membres de l’équipe AMENA CONSULTING mis en avant dans un carousel qui valorise les expertises, les parcours et les rôles de chacun.',
        spotlightLabel: 'Profil mis en avant',
        membersLabel: 'Equipe AMENA',
      },
    },
    servicesPage: {
    ...
    trainingsPage: {
      ...
      registrationDescription: 'Choisissez une session ouverte puis envoyez votre demande d’inscription. Vous serez ensuite recontacté par l’équipe AMENA CONSULTING.',
      ...
      noOpenSessionsTitle: 'Aucune session ouverte pour le moment',
      noOpenSessionsDescription: 'Cette formation ne dispose pas encore de session ouverte à l’inscription. Vous pouvez laisser votre intérêt afin d’être recontacté dès la prochaine ouverture.',
      registrationSuccessTitle: 'Inscription envoyée',
      registrationSuccessMessage: 'Votre demande d’inscription a bien été transmise à notre équipe.',
